...
class Quiztest extends Controller
{
	...
	function __construct()
	{
		...
		parent::__construct('quiztest_model');
	...
	function index()
	{
		...
		$this->viewLoader->render('quiztest_view');
	}
	function nsn()
	{

		$this->viewLoader->tableData = $this->model->getDataQuiz();
		$this->viewLoader->render('nsn_view');
	}
	function xs()
	{

		$this->viewLoader->tableData = $this->model->getDataQuiz();
		$this->viewLoader->render('xs_view');
	}
	function ht()
	{

		$this->viewLoader->tableData = $this->model->getDataQuiz();
		$this->viewLoader->render('ht_view');
	}
	function bt()
	{

		$this->viewLoader->tableData = $this->model->getDataQuiz();
		$this->viewLoader->render('bt_view');
	}
	function insertQuiz()
	{
